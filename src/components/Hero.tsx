...
export default function Hero() {
  ...
  return (
    <div
      className="min-h-[500px] sm:rounded-xl p-8 flex flex-col justify-end relative bg-slate-200"
      style={{
    ...
    >
      ...
      <form className="bg-white max-w-sm flex mt-6 rounded-md relative z-10">
        ...
        />
        <button className="bg-blue-500 hover:bg-blue-600 text-white m-3 py-3 px-5 rounded-lg transition-bg">
          Send
        </button>
      </form>
