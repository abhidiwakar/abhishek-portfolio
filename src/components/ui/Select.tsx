    ...
    <div className="flex flex-col">
      ...
      <div className="mt-2">
        <select
          ...
          {...props}
          className={twMerge(
            "w-full rounded-md border-0 px-2 py-3 text-gray-900 dark:text-gray-100 dark:bg-slate-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6",
            className,
            clsx({
